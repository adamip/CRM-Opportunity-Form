...
/***************************************************************************************/
function showhideOpportunityRecordType()
{
	if( DebugMode ) window.alert( "function showhideOpportunityRecordType" );
	...
	*/
		...
		if( DebugMode ) 
			window.alert( "function showhideOpportunityRecordType switch value = " + val1 );
	...
	{
		if( DebugMode ) window.alert( "function showhideOpportunityRecordType error code = " + err );
	}
}
...
function showhideDealInformation()
{
	...
	{
		if( DebugMode ) window.alert( "function showhideDealInformation error code = " + err );
	}
}
