...
function TotalRevenueEarnedGP_Update()
{
	...
	try
	{
		...
		var val5 = myGetValue( "cust_adtechmanagedservices" );			/* cust_adtechmanagedservices is equal to cust_adtechmanagedservicesgp, if any */
		...
		var val9 = myGetValue( "cust_adtechmanagedservicesearnedgp" );
