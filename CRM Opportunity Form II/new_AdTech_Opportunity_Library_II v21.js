...
function TotalRevenue()
{
	...
	try
	{
		...
		var val8 = myGetValue( "cust_adtechconnectivityrevenue" );
		if( DebugModeOppII ) 
			window.alert( "function TotalRevenue\nval1 " + val1 + "\nval2 " + val2 + "\nval3 " + val3 + "\nval4 " + val4 + "\nval5 " + val5 + "\nval6 " + val6 + "\nval7 " + val7 + "\nval8 " + val8 );		
		
		var out1 = Xrm.Page.getAttribute( "cust_totalrevenue" );	
		Sum8( "Total Revenue", val1, val2, val3, val4, val5, val6, val7, val8, out1 );
		var out2 = Xrm.Page.getAttribute( "estimatedvalue" );	
		Sum8( "Estimated Revenue Value", val1, val2, val3, val4, val5, val6, val7, val8, out2 );	
	}
	catch( err )
	{
...
function TotalCost()
{
	...
	try
	{
		...
		var val6 = myGetValue( "cust_adtechconnectivitycost" );
		var out1 = Xrm.Page.getAttribute( "cust_totalcost" );
		if( DebugModeOppII ) window.alert( "function TotalCost\nval1 " + val1 + "\nval2 " + val2 + "\nval3 " + val3 + "\nval4 " + val4 + "\nval5 " + val5 + "\nval6 " + val6 );
		
		Sum6( "Total Cost", val1, val2, val3, val4, val5, val6, out1 );
	}
	catch( err )
	{
