...
function ThirdPartyHardwareSupportRevenue_Change()
{
	...
	try
	{
		...
		RenewingThirdPartyHardwareSupportRevenue_Update();
		RenewalTrigger_Update();
	}
	catch( err )
	{
...
function ThirdPartyHardwareSupportCost_Change()
{
	...
	try
	{
		...
		RenewingThirdPartyHardwareSupportCost_Update();
		RenewalTrigger_Update();
	}
	catch( err )
	{
...
function ThirdPartySoftwareSupportRevenue_Change()
{
	...
	try
	{
		...
		RenewingThirdPartySoftwareSupportRevenue_Update();
		RenewalTrigger_Update();
	}
	catch( err )
	{
...
function ThirdPartySoftwareSupportCost_Change()
{
	...
	try
	{
		...
		RenewingThirdPartySoftwareSupportCost_Update();
		RenewalTrigger_Update();
	}
	catch( err )
	{
...
function AdtechHardwareSoftwareSupport_Change()
{
	...
	try
	{
		...
		RenewingAdtechHardwareSoftwareSupport_Update();
		RenewalTrigger_Update();
	}	
	catch( err )
	{
...
function AdtechManagedServicesRevenueGP()
{
	...
	try
	{
		/* be awared that no function call is updating cust_adtechmanagedservicescost,
