...
function HardwareRevenuePctOffListUpdate()
{
	...
	try
	{
		...
		PercentageOff( "Hardware Revenue % Off List", val1, val2, out1 );
	}
	catch( err )
	{
...
function HardwareCostPctOffListUpdate()
{
	...
	try
	{
		...
		PercentageOff( "Hardware Cost % Off List", val1, val2, out1 );
	}
	catch( err )
	{
...
function SoftwareRevenuePctOffListUpdate()
{
	...
	try
	{
		...
		PercentageOff( "Software Revenue % Off List", val1, val2, out1 );
	}
	catch( err )
	{
...
function SoftwareCostPctOffListUpdate()
{
	...
	try
	{
		...
		PercentageOff( "Software Cost % Off List", val1, val2, out1 );
	}
	catch( err )
	{
