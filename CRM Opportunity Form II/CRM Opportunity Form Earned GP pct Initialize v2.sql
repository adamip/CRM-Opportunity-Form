...
UPDATE OpportunityExtensionBase
SET cust_AdTechHardwareSoftwareSupportEarnedGP = cust_AdTechHardwareSoftwareSupportGP / cust_LengthOfTermAdTechHardwareSoftwareSupport
...
UPDATE OpportunityExtensionBase
SET cust_AdTechHardwareSoftwareSupportEarnedGP = cust_AdTechHardwareSoftwareSupportEarned / cust_LengthOfTermAdTechHardwareSoftwareSupport
	, cust_AdTechHardwareSoftwareSupportEarnedGP_Base = cust_adtechhardwaresoftwaresupportearned_Base / cust_LengthOfTermAdTechHardwareSoftwareSupport
WHERE cust_LengthOfTermAdTechHardwareSoftwareSupport IS NOT NULL AND cust_LengthOfTermAdTechHardwareSoftwareSupport <> 0;

UPDATE OpportunityExtensionBase
SET cust_AdTechManagedServicesEarnedGP = cust_AdTechManagedServicesEarned / cust_LengthOfTermAdTechManagedServices
	, cust_AdTechManagedServicesEarnedGP_Base = cust_AdTechManagedServicesEarned_Base / cust_LengthOfTermAdTechManagedServices
