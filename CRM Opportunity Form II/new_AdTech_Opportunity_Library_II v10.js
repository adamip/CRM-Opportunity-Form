/*
	...
	Adam Ip																	2012-04-11
	function ThirdPartyHardwareSupportEarned_Change()
	function ThirdPartySoftwareSupportEarned_Change()
	function AdtechHardwareSoftwareSupportEarned_Change()
	function AdtechManagedServicesEarned_Change()
	function SupportEarned_Change()
	*/
...
function LengthOfTermThirdPartyHardwareSupport_Change()
{
	...
	try
	{
		...
		ThirdPartyHardwareSupportEarned_Change();
	}
	catch( err )
	{
...
function LengthOfTermThirdPartySoftwareSupport_Change()
{
	...
	try
	{
		...
		ThirdPartySoftwareSupportEarned_Change();
	}
	catch( err )
	{
...
function LengthOfTermAdtechHardwareSoftwareSupport_Change()
{
	...
	try
	{
		...
		AdtechHardwareSoftwareSupportEarned_Change();
	}	
	catch( err )
	{
...
function LengthOfTermAdtechManagedServices_Change()
{
	...
	try
	{
		...
		AdtechManagedServicesEarned_Change();
	}	
	catch( err )
	{
...
/***************************************************************************************/
function SupportEarned_Change( sLabel1, sLabel2, sLabel3 )
{
	if( DebugModeOppII ) window.alert( "function SupportEarned_Change" );
	...
	try
	{
		...
		if( val2 != null && val2 != 0 )
		{
			...
			if( out3 != null )
			{
				var val1 = myGetValue( sLabel1 );
				if( DebugModeOppII ) 
					window.alert( "function SupportEarned_Change\nval1 " + val1 + "\nval2 " + val2 );
				out3.setSubmitMode( "always" );
				out3.setValue( val1 / val2 );
			}	
		}	
	...
	{
		if( DebugModeOppII ) window.alert( "function SupportEarned_Change error code " + err );
	}
	return;
}
...
function ThirdPartyHardwareSupportEarned_Change()
{
	if( DebugModeOppII ) window.alert( "function ThirdPartyHardwareSupportEarned_Change" );

	try
	{
		SupportEarned_Change( "cust_thirdpartyhardwaresupportrevenue", "cust_lengthoftermthirdpartyhardwaresupport", "cust_thirdpartyhardwaresupportearned" );	
	}	
	catch( err )
	{
		if( DebugModeOppII ) window.alert( "function ThirdPartyHardwareSupportEarned_Change error code " + err );
	}
	return;
}
...
function ThirdPartySoftwareSupportEarned_Change()
{
	if( DebugModeOppII ) window.alert( "function ThirdPartySoftwareSupportEarned_Change" );

	try
	{
		SupportEarned_Change( "cust_thirdpartysoftwaresupportrevenue", "cust_lengthoftermthirdpartysoftwaresupport", "cust_thirdpartysoftwaresupportearned" );	
	}	
	catch( err )
	{
		if( DebugModeOppII ) window.alert( "function ThirdPartySoftwareSupportEarned_Change error code " + err );
	}
	return;
}
...
function AdtechHardwareSoftwareSupportEarned_Change()
{
	if( DebugModeOppII ) window.alert( "function AdtechHardwareSoftwareSupportEarned_Change" );

	try
	{
		SupportEarned_Change( "cust_adtechhardwaresoftwaresupport", "cust_lengthoftermadtechhardwaresoftwaresupport", "cust_adtechhardwaresoftwaresupportearned" );	
	}	
	catch( err )
	{
		if( DebugModeOppII ) window.alert( "function AdtechHardwareSoftwareSupportEarned_Change error code " + err );
	}
	return;
}
...
function AdtechManagedServicesEarned_Change()
{
	if( DebugModeOppII ) window.alert( "function AdtechManagedServicesEarned_Change" );

	try
	{
		SupportEarned_Change( "cust_adtechmanagedservices", "cust_lengthoftermadtechmanagedservices", "cust_adtechmanagedservicesearned" );	
	}	
	catch( err )
	{
		if( DebugModeOppII ) window.alert( "function AdtechManagedServicesEarned_Change error code " + err );
	}
	return;
}
