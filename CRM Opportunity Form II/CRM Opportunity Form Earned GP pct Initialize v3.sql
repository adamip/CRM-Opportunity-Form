...
SET cust_TotalRevenueEarnedGP = ISNULL( cust_TotalGP, 0 ) 
    ...
    + ISNULL( cust_AdtechHardwareSoftwareSupportEarnedGP, 0 ) 
	+ ISNULL( cust_AdtechManagedServicesEarnedGP, 0 )	
    ...
    + ISNULL( cust_AdtechHardwareSoftwareSupportEarnedGP_Base, 0 ) 
	+ ISNULL( cust_AdtechManagedServicesEarnedGP_Base, 0 );
